...
## Debugging output
message(WARNING "[FindPIO] PIO_INCLUDE_DIR: ${PIO_INCLUDE_DIR}")
message(WARNING "[FindPIO] PIO_PREFIX: ${PIO_PREFIX}")
message(WARNING "[FindPIO] PIO_MODULE_DIR: ${PIO_MODULE_DIR}")
message(WARNING "[FindPIO] PIO_C_STATIC_LIB: ${PIO_C_STATIC_LIB}")
message(WARNING "[FindPIO] PIO_C_SHARED_LIB: ${PIO_C_SHARED_LIB}")
message(WARNING "[FindPIO] PIO_C_SHARED_FOUND: ${PIO_C_SHARED_FOUND}")
message(WARNING "[FindPIO] PIO_C_STATIC_FOUND: ${PIO_C_STATIC_FOUND}")
message(WARNING "[FindPIO] PIO_Fortran_STATIC_LIB: ${PIO_Fortran_STATIC_LIB}")
message(WARNING "[FindPIO] PIO_Fortran_SHARED_LIB: ${PIO_Fortran_SHARED_LIB}")
message(WARNING "[FindPIO] PIO_Fortran_SHARED_FOUND: ${PIO_Fortran_SHARED_FOUND}")
message(WARNING "[FindPIO] PIO_Fortran_STATIC_FOUND: ${PIO_Fortran_STATIC_FOUND}")
